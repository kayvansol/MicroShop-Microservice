...
public partial class MicroShopPaymentContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        ...
        => optionsBuilder.UseSqlServer("Data Source=192.168.1.4;Initial Catalog=MicroShopPayment;User ID=sa;Password=ABCabc123456;Persist Security Info=False;Pooling=False;MultipleActiveResultSets=True;Encrypt=False;TrustServerCertificate=True");
